...
var InvoiceEntryComponent = /** @class */ (function () {
    function InvoiceEntryComponent(fb) {
        this.fb = fb;
        this.title = 'invoice entry';
        this.createForm();
    }
    InvoiceEntryComponent.prototype.createForm = function () {
    ...
    InvoiceEntryComponent.ctorParameters = function () { return [
...
var ItemCreationComponent = /** @class */ (function () {
    function ItemCreationComponent(fb) {
        this.fb = fb;
        this.title = 'Item Creation';
        this.createForm();
    }
    ItemCreationComponent.prototype.createForm = function () {
        this.angForm = this.fb.group({
    ...
    ItemCreationComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
    ]; };
...
var PartyCreationComponent = /** @class */ (function () {
    function PartyCreationComponent(fb) {
        this.fb = fb;
        this.title = 'Party Creation';
        this.createForm();
    }
    PartyCreationComponent.prototype.createForm = function () {
        this.angForm = this.fb.group({
    ...
    PartyCreationComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
    ]; };
